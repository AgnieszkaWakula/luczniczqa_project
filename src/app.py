...
app = FastAPI(
    title="EGNYTE WORKSHOPS 25.05.2022 ♥",
    description="EGNYTE API will help you during the workshop with 'Introduction to API Testing in Python'",
    contact={
...
@app.get("/", tags=["Root"])
async def read_root():
    return {"message": "Welcome to EGNYTE API Testing app."}
